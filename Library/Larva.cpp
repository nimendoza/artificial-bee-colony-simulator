...
#include "Larva.h"
#include "Bees.h"
const float Larva::EMERGE_TIME_QUEEN{ 24 * 5.0F / TIME_SCALING };
const float Larva::EMERGE_TIME_DRONE{ 24 * 5.5F / TIME_SCALING };
const float Larva::EMERGE_TIME_WORKER{ 24 * 6.0F / TIME_SCALING };
